/**
 * This file holds the information for Nowell Althaus.
 */

defineJohnson = function() {
  let acID = RadGrad.user.findBySlug("johnson")._id;
  ...
  RadGrad.user.setPicture(acID, "http://matthias.vallentin.net/img/portrait.jpg");
  RadGrad.user.setAboutMe(acID, "I wish to create beautiful and interesting web and software applications.");
